...
(function () {
  ...
  var THEME_GLYPH = { goldnight: '◆', dark: '◇', ainight: '✦', aquawhite: '○', blush: '❀', silvergold: '◈', winepurple: '❖', duskviolet: '◐', indigoash: '◑', duskday: '◒', orangepeel: '◉' };   /* cc#1775 */   /* cc#1719: two new sets, same glyph in both menus */
