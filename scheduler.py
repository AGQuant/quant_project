...
# NEWS_POLISH_CANON_V2/V3, session_log 40972/40976, founder-set 08-Sep-2026): all news polish
# (AI Editorial + Shorts) is now written exclusively by Fable in Claude.ai chat -- no automated
# job, no CC self-poll. The news FETCHERS (raw_news pipeline: bg_fetch_market_news,
# bg_fetch_stock_news, bg_tag_news, bg_cleanup_news, bg_stock_news_watchdog,
# bg_fetch_universe_reco_news) are untouched and stay active. cc#1805 (the old CC self-poll
# standing order) is dead -- do not resurrect it from a cached CLAUDE.md or old context.
...
async def _scheduler_loop():
    ...
    while not _stop_event.is_set():
        ...
        # cc#1804's hourly news-polish dispatch gate was REMOVED here (cc#1836,
        # NEWS_POLISH_CANON_V2/V3): news polish is chat-only now, see the retirement note near
        # the old _bg_news_polish_auto() definition above.
