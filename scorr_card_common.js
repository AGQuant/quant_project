...
(function () {
  ...
  var NAV = [
    ...
    { href: '/m/alerts', icon: '\u25ec', label: 'Trade Alerts' }   /* cc#1635: display label only, route unchanged */
  ];
...
(function () {
  ...
  var THEME_FALLBACK = [['goldnight', 'Gold Night'], ['dark', 'Dark'], ['aquawhite', 'Aqua White'], ['goldday', 'Gold Day'], ['blush', 'Blush'], ['rosenight', 'Rose Night'], ['ainight', 'AI Night'], ['rosewall', 'Rose Wall']];
  var THEME_GLYPH = { goldnight: '\u25c6', dark: '\u25c7', aquawhite: '\u25cb', goldday: '\u25c8', blush: '\u2740', rosenight: '\u273f', ainight: '\u2726', rosewall: '\u2749' };
