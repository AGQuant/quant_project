...
(function () {
  ...
  var NAV = [
    ...
    /* cc#1506 (MANUAL_TRADE_ALERTS_V1, 34521): slot 5 Intel -> Alerts. /m/intel (news) stays
       ...
       same card are the no-JS fallback kept consistent. cc#1662 (founder 04-Sep 10:30 IST): nav
       labels are ONE WORD (Home, V8, GVM, Check, Alerts) \u2014 "Trade Alerts" is the PAGE TITLE
       (the shell .as-pg .t / the page's own hidden .ia-h1), not the tab. */
    { href: '/m/alerts', icon: '\u25ec', label: 'Alerts' }   /* cc#1662: was 'Trade Alerts' (cc#1635); route/icon unchanged */
  ];
...
(function () {
  ...
  var THEME_FALLBACK = [['goldnight', 'Gold Night'], ['dark', 'Midnight Blue'], ['ainight', 'AI Night'], ['electricviolet', 'Electric Violet'], ['indigoash', 'Indigo Ash'], ['aquawhite', 'Aqua White'], ['silvergold', 'Silver Gold'], ['blush', 'Blush'], ['duskday', 'Dusk Day'], ['orangepeel', 'Orange Peel']];   /* cc#1791: mirrors NAMES — Orange Peel last (10) */   /* cc#1790: mirrors NAMES — Dusk Day last in the light group (9) */   /* cc#1776: Wine Purple withdrawn (final 8) */   /* cc#1775: mirrors NAMES — the two new dark sets after AI Night, Blush still last */   /* cc#1750: mirrors NAMES order (Blush last); the menu reads NAMES first, this only when the resolver is absent */   /* cc#1654: Dark back per founder 04-Sep; mirrors pwa_endpoints NAMES - goldday/rosenight/rosewall stay hidden */
  var THEME_GLYPH = { goldnight: '\u25c6', dark: '\u25c7', ainight: '\u2726', aquawhite: '\u25cb', blush: '\u2740', silvergold: '\u25c8', winepurple: '\u2756', duskviolet: '\u25d0', indigoash: '\u25d1', duskday: '\u25d2', orangepeel: '\u25c9', electricviolet: '\u25d0' };   /* cc#1775: same glyphs as the app-shell menu */   /* cc#1719: two new sets, same glyph in both menus */
