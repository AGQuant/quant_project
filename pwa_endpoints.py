...
APP_THEME_RESOLVE_JS = """(function(){
  ...
  var REMAP={goldday:'aquawhite',rosenight:'blush',rosewall:'blush',winepurple:'duskviolet'};   /* cc#1776: a phone left on Wine Purple lands on Dusk Violet ONCE, written back (remapped() below), so the switcher tick has a row to land on */   /* cc#1654: the dark->ainight
